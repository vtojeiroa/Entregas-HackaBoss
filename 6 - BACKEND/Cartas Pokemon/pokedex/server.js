...
/*
  ...
  - si la búsqueda es de menos de 2 letras debe dar un error
...
app.get("/", (req, res) => {
  ...
  res.status(200).send(pageLayout({ title: "Portada", content: pageContent }));
});
...
app.get("/pokemon/:id", (req, res) => {
  ...
  const pageContent = file({ pokemon });
